...
class FraisGestionFactory
{
    public static function create(?array $attributes = [])
    {
        ...
        return [
            ...
            'montant_plafond_commande' => $attributes['montant_plafond_commande'] ?? null,
            'nb_frais_gestion' => $attributes['nb_frais_gestion'] ?? null,
            'prix_frais_gestion' => $attributes['prix_frais_gestion'] ?? null,
            'nb_frais_demat' => $attributes['nb_frais_demat'] ?? null,
            'prix_frais_demat' => $attributes['prix_frais_demat'] ?? null,
            'nb_frais_papier' => $attributes['nb_frais_papier'] ?? null,
            'prix_frais_papier' => $attributes['prix_frais_papier'] ?? null,
        ];
    }
}
